...
from pickle import load as laad_dieren_van_schijf
from pickle import dump as bewaar_dieren_op_schijf
...
f = open('dieren.txt', 'wb')
p = bewaar_dieren_op_schijf(dieren, f)
f.close()
